...
import { fetchAllDriversAttendance , fetchAttendanceBelowAvgCount } from "../../stateManagement/driverSlice";

export default function ViewAttendanceStats(){
    ...
    const dateChange=async(date)=>{
        ...
        await dispatch(fetchAllDriversAttendance())
        }
    ...
    return (
        <>
          ...
          : null}
                ...
                <br></br>
                <DriverStatsTable selectedMonth={selectedMonth} filter={filter}/>
                </>
                )
                }