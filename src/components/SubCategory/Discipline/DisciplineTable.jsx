...
import { deleteDiscipline, fetchAllDisciplines } from '../../../stateManagement/disciplineSlice';
...
const DisciplineTable = () => {
  ...
  const handleEdit = (disciplineId) => {
    openEditModal()
    setId(disciplineId)
  };

  const handleDeleteIcon = (disciplineId) => {
  ...
  return (
    <>
            ...
            <Table stickyHeader>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell style={{ fontWeight: 'bold', borderBottom: '3px solid #770043', width: '35%', fontFamily: "Outfit" }}>
                    Discipline
                  </TableCell>
              ...
              <TableBody style={{ overflowY: 'auto' }}>
                {disciplines.map((discipline, index) => (
                  <TableRow key={discipline._id}>
                    ...
                    <TableCell sx={{ fontFamily: "Outfit" }}>{discipline.discipline}</TableCell>
                    <TableCell>
                      <EditIcon
                        sx={{
                          color: "#770043"
                        }}
                        onClick={() => handleEdit(discipline._id)}
                      />
                    </TableCell>
                    <TableCell>
                      <DeleteIcon
                        ...
                        onClick={() => handleDeleteIcon(discipline._id)}
                      />
                    </TableCell>
                  </TableRow>
                ))}
      ...
      <FormModal isOpen={isAddModalOpen} onClose={closeAddModal}>
        <AddDiscipline closeModal={closeAddModal} />
      </FormModal>
      <FormModal isOpen={isEditModalOpen} onClose={closeEditModal} >
        <EditDiscipline id={id}   closeModal={closeEditModal} />
      </FormModal>
    </>
  );
};
