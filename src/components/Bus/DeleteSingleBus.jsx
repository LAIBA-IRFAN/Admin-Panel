...
import { deleteABusId, fetchAllBusIds } from '../../stateManagement/busSlice';
...
export default function DeleteSingleBus({deleteModal , setDeleteModal , selectedId}) {

    const dispatch = useDispatch()

    const Delete=async()=>{
        console.log(selectedId)
        const response = await dispatch(deleteABusId(selectedId))
