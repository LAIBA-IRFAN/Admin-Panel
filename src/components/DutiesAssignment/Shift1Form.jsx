...
const Shift1Form = ({viewModal , setViewModal , setShift1Form , setShift1Table}) => {
  ...
  // const routeNumber = routes.filter((route)=> route.routeNo === count)
  ...
  // useEffect(() => {
  //   console.log(busId); // Log the updated busId whenever it changes
  // }, [busId]);

  // const handleChangeBus = (e , rowid) => {
  //   console.log(busId)
  //   setBusId((oldArray)=>{
  //     return[
  //       ...oldArray,
  //       {[rowid+1] : e.target.value}
  //     ]
  //   });
  // };
  // const handleChangeDriver = (e , rowid) => {
  //   console.log(driverId)
  //   setDriverId((oldArray)=>{
  //     return[
  //       ...oldArray,
  //       {[rowid+1] : e.target.value}
  //     ]
  //   });
  // };
  // const handleChangeConductor = (e , rowid) => {
  //   console.log(conductorId)
  //   setConductorId((oldArray)=>{
  //     return[
  //       ...oldArray,
  //       {[rowid+1] : e.target.value}
  //     ]
  ...
  const CreateBus = async(routeId,routeNo,index)=>{
    try{
      const response = await dispatch(createBus({routeId,busId,driverId,conductorId,shift:1}))
      if(response){
